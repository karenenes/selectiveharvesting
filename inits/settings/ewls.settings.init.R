...
# Available models.
source("models/ewls/ewls.R")

#################################################################################################
MODELS <- list(EWLS$new(beta=0.99, lambda=1.0))
#################################################################################################
...
# ===============================================================================================
# flickr1
SETTINGS$flickr1 <- Settings$new(problem=PROBLEMS$flickr1, rng_seed=112358, nattempts=1400, models=MODELS)
# youtube
SETTINGS$youtube <- Settings$new(problem=PROBLEMS$youtube, rng_seed=112358, nattempts=1400, models=MODELS)
# blogcatalog1
SETTINGS$blogcatalog1 <- Settings$new(problem=PROBLEMS$blogcatalog1, rng_seed=112358, nattempts=1400, models=MODELS)
# ===============================================================================================
# dbpedia
...
# flickr
SETTINGS$flickr <- Settings$new(problem=PROBLEMS$flickr, rng_seed=112358, nattempts=2000, models=MODELS)
# ppi
SETTINGS$ppi <- Settings$new(problem=PROBLEMS$ppi, rng_seed=112358, nattempts=2000, models=MODELS)
# cora
SETTINGS$cora <- Settings$new(problem=PROBLEMS$cora, rng_seed=112358, nattempts=1100, models=MODELS)
# amazon
SETTINGS$amazon <- Settings$new(problem=PROBLEMS$amazon, rng_seed=112358, nattempts=2000, models=MODELS)
