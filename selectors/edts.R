...
##
 ...
 ##
PolicyEDTS <- R6Class("PolicyEDTS",
                    inherit = SingleArmSelector,
                      
    public = list(
        initialize = function(C=1,epsilon=0.1) {
          private$C = C
        ...
        getName = function()
        {
          return (sprintf("Epsilon-Dynamic Thompson Sampling, C = %.2f, Eps=%.2f", private$C, private$epsilon))
        },
