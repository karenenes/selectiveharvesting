...
##
 ...
 ##
PolicyEGdyn <- R6Class("PolicyEGdyn",
    ...
    public = list(
        ...
        getName = function()
        {
          return (sprintf("epsilon-Greedy (dynamic), eps=%s", private$epsilon))
        },
        ...
        {
          if (runif(1) < private$epsilon*(1-simulation_state$current_turn/simulation_state$final_turn)) {
